			  ...
			  <div class="row">
				<div class="col-md-12">
					...
					if(isset($_GET['delete'])){
						...
						$check_edit_q = mysqli_query($db, "SELECT * FROM history_manual WHERE order_id = '$order_id'");
					...
					if(isset($_GET['edit'])){
						...
						if(mysqli_num_rows($check_edit_q)<1){
							...
							<div class="box box-primary box-solid">
								...
								<!-- /.box-header -->
								<div class="box-body">
									<form method="post" action="act.php?editorderman" id="edit">
										<div id="result"></div>
					...
					<div class="box box-primary box-solid">
						...
						<div class="box-body">
						  <table class="table table-bordered">
							...
							<? $q_x = mysqli_query($db, "SELECT * FROM history_manual");
